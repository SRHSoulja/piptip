...
async function create2MinTip() {
  console.log('Creating 2-minute group tip...');
  ...
  try {
    ...
    // Create a new group tip that expires in 2 minutes
    ...
    console.log('✅ Created 2-minute group tip:', tip.id, 'expires in 2 minutes');
