 ...
 */
export async function logCompleteTransaction(tx, params) {
    const { operation, userId, otherUserId, guildId, balanceChanges, metadata, blockchainTxHash, idempotencyKey, source = 'BOT', status = 'CONFIRMED', opRef } = params;
 ...
 */
export async function logTip(tx, params) {
...
export async function logDeposit(tx, params) {
    return logCompleteTransaction(tx, {
        operation: 'DEPOSIT',
...
export async function logWithdraw(tx, params) {
    const balanceChanges = [
        {
            tokenId: params.tokenId,
            userId: params.userId,
...
export async function logPredictionWager(tx, params) {
    return logCompleteTransaction(tx, {
...
export async function logPredictionPayout(tx, params) {
    return logCompleteTransaction(tx, {
...
export async function logTreasurySwap(tx, params) {
    return logCompleteTransaction(tx, {
...
export async function logSnapshotPublish(tx, params) {
    return logCompleteTransaction(tx, {
...
export async function logTxAtomicTx(db, params) {
    const { userId, otherUserId = null, guildId = null, type, tokenId, amountAtomic, feeAtomic = 0n, txHash = null, note = null } = params;
