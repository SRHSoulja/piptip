...
const API_COMPATIBLE_TEMPLATES = [
  {
...
const marketTemplates = new MarketTemplateService();
console.log("\u{1F4CB} Market template system loaded with API and manual types");
export {
  ADMIN_SPECIAL_TEMPLATES,
  API_COMPATIBLE_TEMPLATES,
  MarketTemplateService,
  marketTemplates
};
//# sourceMappingURL=market_templates.js.map
