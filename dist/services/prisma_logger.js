...
prismaWithLogging.$on("query", (e) => {
  ...
  if (duration >= SLOW_QUERY_THRESHOLD_MS) {
    ...
    const trimmedSql = e.query.replace(/\s+/g, " ").trim().substring(0, 200);
...
function taggedPrismaOperation(operation, operationName) {
...
async function healthCheckQuery(timeoutMs = 200) {
  try {
...
export {
  healthCheckQuery,
  prismaWithLogging,
  taggedPrismaOperation
};
//# sourceMappingURL=prisma_logger.js.map
