...
class AchievementMonitor extends EventEmitter {
    ...
    async checkRecentUnlocks() {
        ...
        try {
            ...
            if (recentUnlocks.length > 0) {
                ...
                const rareUnlocks = recentUnlocks.filter(u => ['rare', 'epic', 'legendary'].includes(u.definition.rarity));
    ...
    async generateAnalyticsSummary() {
        ...
        try {
            ...
            const [hourlyUnlocks, dailyUnlocks, activeUsers, topCategories, difficultAchievements] = await Promise.all([
            ...
            const summary = {
                ...
                topCategories,
                difficultAchievements: difficultAchievements
            };
            // Emit summary event
...
export function startAchievementMonitoring() {
    achievementMonitor.start();
}
export function stopAchievementMonitoring() {
...
export function attachWebSocketHandlers(io) {
