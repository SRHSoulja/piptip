...
export class StatsService {
    async getBotStats() {
        ...
        const [kpis, serverBreakdown, tokenBreakdown, globalStats, highlights, timeBreakdown] = await Promise.all([
            this.getKPIs(),
    ...
    async getServerBreakdown() {
        ...
        return serverStats.sort((a, b) => (b.tipCount + b.gameCount + b.groupTipCount) - (a.tipCount + a.gameCount + a.groupTipCount));
    }
