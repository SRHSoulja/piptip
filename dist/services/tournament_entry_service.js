...
async function enterTournamentWithPayment(params) {
  ...
  try {
    const tournament = await prisma.tournament.findUnique({
      ...
      select: {
        ...
        name: true,
        entryFee: true,
        // Assuming this is stored in USD
        startingPIPChips: true,
        // This becomes TPIP allocation
        guildId: true,
        status: true
      }
    });
    ...
    const config = {
      ...
      guildId: tournament.guildId ?? void 0
    };
...
async function calculateEntryPayment(params) {
  try {
...
async function getTournamentEntryStatus(params) {
  ...
  return {
    ...
    entryPayments: entryPayments.length > 0 ? entryPayments : void 0
  };
}
export {
...
//# sourceMappingURL=tournament_entry_service.js.map
