...
class AlchemyTokenMetadataService {
  ...
  async exploreAvailableMethods(tokenAddress) {
    ...
    console.log(`\u{1F50D} Exploring Alchemy metadata for token: ${tokenAddress}`);
    try {
  ...
  async analyzeToken(tokenAddress) {
    console.log(`
\u{1F50D} ANALYZING TOKEN: ${tokenAddress}
`);
    try {
      const exploration = await this.exploreAvailableMethods(tokenAddress);
      console.log("\u{1F4CA} AVAILABLE METHODS:");
...
const alchemyTokenMetadata = new AlchemyTokenMetadataService();
export {
  alchemyTokenMetadata
};
//# sourceMappingURL=alchemy_token_metadata.js.map
