...
export function initializeCriteriaRegistry() {
...
export async function evaluateAchievementCriteria(userId, criteriaType, criteriaData, eventData) {
...
export function getCriteriaDescription(criteriaType, criteriaData) {
    const evaluator = CriteriaRegistry.get(criteriaType);
    if (!evaluator) {
