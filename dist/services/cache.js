...
class MapCache {
    cache = new Map();
    cleanupInterval;
    maxSize = 5000; // Increased for better hit rates under high load
    constructor() {
...
export const CacheKeys = {
    ...
    userStreak: (userId) => `streak:${userId}`,
...
export async function cacheWithMetrics(key, fetchFn, ttlSeconds = 30) {
