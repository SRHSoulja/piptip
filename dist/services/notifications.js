...
export function queueAchievementNotifications(discordId, achievements, context) {
...
export function initializeNotificationSystem(client) {
...
export function getPendingNotificationCount(discordId) {
...
export function clearPendingNotifications(discordId) {
