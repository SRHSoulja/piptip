 ...
 */
export function scrubSecrets(message) {
 ...
 */
export function scrubSecretsFromObject(obj) {
...
export function secureLog(message, ...args) {
    ...
    const scrubbed_args = args.map(arg => typeof arg === 'string' ? scrubSecrets(arg) : scrubSecretsFromObject(arg));
