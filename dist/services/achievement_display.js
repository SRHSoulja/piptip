...
export function formatAchievementBadge(achievement, showProgress = false) {
    ...
    const rarityIndicator = rarityIndicators[achievement.rarity] || '🐧';
...
export function getAchievementCategoryInfo(category) {
    const categoryData = {
        streaks: {
...
export function formatDetailedAchievement(achievement) {
