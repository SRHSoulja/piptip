...
export async function queueNotice(userId, type, payload) {
    try {
...
export async function flushNoticesEphemeral(i) {
...
export async function flushNoticesEphemeralWithRetry(i, maxRetries = 2) {
