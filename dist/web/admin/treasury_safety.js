...
treasurySafetyRouter.post("/config", async (req, res) => {
    try {
        const { treasuryMaxHoldingUSD, treasuryWarningThresholdUSD, coldWalletAddress, treasuryMonitoringEnabled, autoTransferEnabled, treasuryCheckIntervalMins } = req.body;
        // Validate inputs
