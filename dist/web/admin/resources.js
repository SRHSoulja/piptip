...
// GET /admin/resources - Current resource status
...
// GET /admin/resources/history - Resource usage history
...
// GET /admin/resources/alerts - Current alerts
...
// GET /admin/resources/upgrade-check - Check if upgrade is recommended
router.get('/upgrade-check', async (req, res) => {
    try {
        ...
        const upgradeNeeded = {
            ...
            recommended: alerts.some(a => a.level === 'warning') ||
                summary.averages.memoryUsage > 75 ||
                summary.averages.cpuUsage > 70,
            currentSpecs: {
                vcpu: 0.5,
                ram: '2 GiB',
                cost: 'Lower tier'
