  ...
  try {
    ...
    <div class="pg-container">
        ...
        <div class="pg-success-banner" style="margin-bottom: var(--pg-space-6);">
            \u{1F389} Welcome! You've successfully joined via referral link!
        </div>
        ` : ""}
        ...
        <div class="pg-card" style="margin-top: var(--pg-space-6);">
            <h2 style="margin: 0 0 var(--pg-space-4) 0; color: var(--pg-dark-800);">\u{1F3A8} Aesthetic Customization</h2>
            ...
            <div class="pg-customization-section">
                <h3 class="pg-customization-title">\u{1F319} Theme & Appearance</h3>
            ...
            <!-- Accent Color Picker -->
            <div class="pg-customization-section">
                <h3 class="pg-customization-title">\u{1F3AF} Accent Color</h3>
            ...
            <!-- Layout Density -->
            <div class="pg-customization-section">
                <h3 class="pg-customization-title">\u{1F4CF} Layout Density</h3>
    ...
    <script>
        document.getElementById('profileForm').addEventListener('submit', async (e) => {
            ...
            submitBtn.textContent = '\u{1F4BE} Saving...';
        ...
        class PenguBookAesthetics {
            ...
            showAchievementNotification(title, text) {
                ...
                notification.innerHTML = \`
                    <div class="pg-achievement-unlock__title">\u{1F3A8} \${title}</div>
