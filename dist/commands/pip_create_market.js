        ...
        switch (marketType.toUpperCase()) {
            ...
            case 'SPORTS_WINNER':
                ...
                if (league) {
                    ...
                    if (upcomingGames.success && upcomingGames.games) {
                        ...
                        gameResult = upcomingGames.games.find((game) => teams.toLowerCase().includes(game.homeTeam.toLowerCase()) &&
            ...
            case 'SPORTS_OVER_UNDER':
                ...
                if (league) {
                    const upcomingGames = await sportsResolver.fetchUpcomingGames(league);
                    if (upcomingGames.success && upcomingGames.games) {
                        ouGameResult = upcomingGames.games.find((game) => teams.toLowerCase().includes(game.homeTeam.toLowerCase()) &&
                            teams.toLowerCase().includes(game.awayTeam.toLowerCase()));
                    }
                }
                if (!ouGameResult) {
            ...
            case 'SPORTS_SPREAD':
                ...
                if (league) {
                    const upcomingGames = await sportsResolver.fetchUpcomingGames(league);
                    if (upcomingGames.success && upcomingGames.games) {
                        spreadGameResult = upcomingGames.games.find((game) => teams.toLowerCase().includes(game.homeTeam.toLowerCase()) &&
                            teams.toLowerCase().includes(game.awayTeam.toLowerCase()));
                    }
                }
                if (!spreadGameResult) {
