...
export default async function execute(i) {
...
async function handleGetReferralCode(i) {
    ...
    try {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(`Share this code with friends to earn rewards when they join and tip!\n\n` +
    ...
    try {
        ...
        if (result.success) {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`Welcome to the PIPtip family! You've successfully used referral code: \`${code}\`\n\n` +
                `🎁 **Benefits Unlocked:**\n` +
