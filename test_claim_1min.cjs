...
async function testClaim1Min() {
  console.log('Testing claim functionality for 1-minute group tip 25...');
  ...
  try {
    ...
    // Use the exact same transaction logic as the fixed button handler
    ...
    console.log(`✅ Claim test successful in ${duration}ms!`, result);
