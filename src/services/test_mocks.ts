 ...
 */
export async function getMockTokenPrice(symbol: string): Promise<number> {
...
export function getValidTransactionTypes() {
  return {
    ...
    STARTING_BONUS: 'STARTING_BONUS' as const,
    ...
    BET_REFUNDED: 'BET_REFUNDED' as const,

    // Prediction markets
    PREDICTION_BET: 'PREDICTION_BET' as const,
    PREDICTION_WIN: 'PREDICTION_WIN' as const,
    PREDICTION_LOSS: 'PREDICTION_LOSS' as const,

    // Tournaments
    TOURNAMENT_ENTRY: 'TOURNAMENT_ENTRY' as const,
    TOURNAMENT_BET: 'TOURNAMENT_BET' as const,
    TOURNAMENT_WIN: 'TOURNAMENT_WIN' as const,
    TOURNAMENT_PRIZE: 'TOURNAMENT_PRIZE' as const,

    // Admin operations
    ADMIN_CREDIT: 'ADMIN_CREDIT' as const,
    ADMIN_DEBIT: 'ADMIN_DEBIT' as const,

    // Referrals
    REFERRAL_BONUS: 'REFERRAL_BONUS' as const,
  };
}
