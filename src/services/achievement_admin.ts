...
import { invalidateDefinitionCache, getAchievementDefinitions, processAchievementEvent } from './dynamic_achievements.js';
...
async function calculateProgressForUser(userId: number, definition: any): Promise<number> {
...
export async function importAchievementDefinitions(
  definitionsData: any[],
