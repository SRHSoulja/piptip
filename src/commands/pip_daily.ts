// src/commands/pip_daily.ts - Claim daily PIPChips bonus with streak mechanics
...
export default async function pipDaily(i: ChatInputCommandInteraction) {
  try {
    ...
    if (claimResult.newStreak === 1) {
      ...
      embed.addFields({
        ...
        value: milestoneRewards[claimResult.newStreak as keyof typeof milestoneRewards],
        inline: false
      });
    }
