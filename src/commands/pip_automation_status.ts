// src/commands/pip_automation_status.ts - Show automation system status
import type { ChatInputCommandInteraction } from "discord.js";
import { EmbedBuilder } from "discord.js";
import { marketAutomationScheduler } from "../services/market_automation_scheduler.js";
import { prisma } from "../services/db.js";

export default async function pipAutomationStatus(i: ChatInputCommandInteraction) {
  try {
    ...
    const nextRun = schedules.reduce((earliest, current) =>
