// src/middleware/channel_check.ts - Channel permission middleware for commands
import type { ChatInputCommandInteraction } from "discord.js";
import { MessageFlags, ActionRowBuilder, ButtonBuilder, ButtonStyle } from "discord.js";
import { checkChannelPermissions, logChannelActivity, type CommandCategory } from "../services/channel_manager.js";

export async function withChannelCheck<T extends ChatInputCommandInteraction>(
  interaction: T,
  commandCategory: CommandCategory,
  commandHandler: (interaction: T) => Promise<any>
): Promise<void> {
...
export function getCommandCategory(commandName: string): CommandCategory {
...
export async function withAutoChannelCheck<T extends ChatInputCommandInteraction>(
  interaction: T,
  commandHandler: (interaction: T) => Promise<any>
): Promise<void> {
