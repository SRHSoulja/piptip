 ...
 */
adminMarketsRouter.get("/markets", async (req: Request, res: Response) => {
  try {
 ...
 */
adminMarketsRouter.post("/markets/:id/resolve", async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
adminMarketsRouter.post("/markets/create", async (req: Request, res: Response) => {
  try {
    const {
      title,
      description,
 ...
 */
adminMarketsRouter.delete("/markets/:id", async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
function generateMarketsAdminHTML(data: {
  stats: { total: number; active: number; resolved: number; expired: number };
  markets: any[];
}): string {
