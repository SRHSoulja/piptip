...
export async function getDeadLetterDashboard(req: Request, res: Response) {
  try {
    ...
    const escalationLevel = req.query.escalation as string;
...
export async function getDeadLetterJob(req: Request, res: Response) {
  try {
    const { id } = req.params;
...
export async function dismissDeadLetterJob(req: Request, res: Response) {
  try {
    const { id } = req.params;
...
export async function getDeadLetterStats(req: Request, res: Response) {
  try {
    const stats = await deadLetterWorker.getDeadLetterStats();
