...
pengubookRouter.get("/pengubook/profiles", async (req: Request, res: Response) => {
  try {
...
pengubookRouter.get("/pengubook/profile/:discordId", async (req: Request, res: Response) => {
  try {
...
pengubookRouter.post("/pengubook/ban", async (req: Request, res: Response) => {
  try {
...
// Unban a user
pengubookRouter.post("/pengubook/unban", async (req: Request, res: Response) => {
  try {
...
pengubookRouter.delete("/pengubook/profile/:discordId", async (req: Request, res: Response) => {
  try {
    const { discordId } = req.params;
...
pengubookRouter.get("/pengubook/stats", async (req: Request, res: Response) => {
  try {
    const [
      totalProfiles,
      activeProfiles,
