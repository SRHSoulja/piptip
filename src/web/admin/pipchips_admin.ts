 ...
 */
pipchipsAdminRouter.get("/", async (req: Request, res: Response) => {
  try {
 ...
 */
pipchipsAdminRouter.get("/users", async (req: Request, res: Response) => {
  try {
 ...
 */
pipchipsAdminRouter.post("/users/:discordId/adjust", async (req: Request, res: Response) => {
  try {
 ...
 */
pipchipsAdminRouter.get("/packages", async (req: Request, res: Response) => {
  try {
 ...
 */
pipchipsAdminRouter.post("/packages", async (req: Request, res: Response) => {
  try {
 ...
 */
pipchipsAdminRouter.post("/markets/:marketId/resolve", async (req: Request, res: Response) => {
  try {
    const { marketId } = req.params;
    const { winningOutcome } = req.body;
    const adminUserId = (req as any).user?.discordId;
 ...
 */
pipchipsAdminRouter.get("/settings", async (req: Request, res: Response) => {
  try {
 ...
 */
pipchipsAdminRouter.post("/settings", async (req: Request, res: Response) => {
  try {
...
function generatePIPChipsAdminHTML(data: any) {
...
function generateUserManagementHTML(data: any) {
...
function generatePackageManagementHTML(packages: any[]) {
  return `
    <!DOCTYPE html>
    <html>
    <head>
...
function generateSettingsHTML(settings: Record<string, any>) {
  return `
    <!DOCTYPE html>
    <html>
    <head>
