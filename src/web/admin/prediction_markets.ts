 ...
 */
predictionMarketsRouter.get("/prediction_markets", async (req: Request, res: Response) => {
  try {
 ...
 */
predictionMarketsRouter.post("/prediction_markets/:id/resolve", async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
predictionMarketsRouter.delete("/prediction_markets/:id", async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
predictionMarketsRouter.post("/prediction_markets/:id/force-resolve", async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
predictionMarketsRouter.get("/prediction_markets/stats", async (req: Request, res: Response) => {
  try {
    const [
      totalMarkets,
      activeMarkets,
 ...
 */
predictionMarketsRouter.get("/prediction_markets/config", async (req: Request, res: Response) => {
  try {
    const config = marketConfig.getConfig();
 ...
 */
predictionMarketsRouter.put("/prediction_markets/config", async (req: Request, res: Response) => {
  try {
 ...
 */
predictionMarketsRouter.post("/prediction_markets/automation/restart", async (req: Request, res: Response) => {
  try {
 ...
 */
predictionMarketsRouter.post("/prediction_markets/resolve-expired", async (req: Request, res: Response) => {
  try {
