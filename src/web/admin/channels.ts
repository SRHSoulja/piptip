...
channelsRouter.get("/channels", async (_req: Request, res: Response) => {
  try {
...
channelsRouter.get("/channels/:guildId", async (req: Request, res: Response) => {
  try {
...
channelsRouter.put("/channels/:guildId", async (req: Request, res: Response) => {
  try {
    const { guildId } = req.params;
...
channelsRouter.post("/channels/:guildId/reset", async (req: Request, res: Response) => {
  try {
    const { guildId } = req.params;
...
channelsRouter.get("/channels/:guildId/activity", async (req: Request, res: Response) => {
  try {
    const { guildId } = req.params;
...
channelsRouter.get("/channels/stats/overview", async (_req: Request, res: Response) => {
  try {
    const [
      totalSettings,
      settingsByMode,
...
channelsRouter.get("/channels/stats/most-active", async (req: Request, res: Response) => {
  try {
...
channelsRouter.post("/channels/bulk/update-mode", async (req: Request, res: Response) => {
  try {
...
channelsRouter.get("/channels/:guildId/summary", async (req: Request, res: Response) => {
  try {
    const { guildId } = req.params;
